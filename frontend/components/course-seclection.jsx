...
//   const [roll, setRoll] = useState(''); // Assuming student roll is available

//   const fetchCourses = async () => {
//     try {
//       const response = await axios.post('http://localhost:3001/api/initial-course-selection', {
//         roll,
//         session,
//         semester
//       });
...
//       setSelectedCourses(selectedCourses.filter(code => code !== course_code));
//     } else {
...
//     try {
//       await axios.post('http://localhost:3001/api/submit-course-selection', {
//         roll,
//         session,
//         semester,
//         selectedCourses
...
//         <input type="text" value={session} onChange={(e) => setSession(e.target.value)} className="p-2 border rounded" />
//       </div>

//       <button onClick={fetchCourses} className="bg-blue-500 text-white px-4 py-2 rounded">Fetch Courses</button>
...
//           <button onClick={handleSubmit} className="bg-green-500 text-white px-4 py-2 rounded mt-4">Submit Selection</button>
//         </div>
//       )}
//     </div>
//   );
...
export default function CourseSelection() {
  ...
  const handleSubmit = async () => {
    try {
      const response = await axios.post('http://localhost:3001/api/submit-course-selection', {
        roll,
        session,
        semester,
        selectedCourses
