...
//         <h1 className="text-2xl font-bold mb-4 text-center">Upload Result</h1>
//         <form onSubmit={handleSubmit} className="space-y-4">
//           <div>
...
export default function UploadResult() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setUploadedResults(response.data.uploadedResults);
    } catch (error) {
      console.error(
        "Error uploading data:",
        error.response ? error.response.data : error.message
          ...
          <table className="w-full text-left">
            ...
            <tbody>
              {uploadedResults.map((result, index) => (
                <tr key={index}>
                  <td className="border px-4 py-2">{result.student_roll}</td>
                  <td className="border px-4 py-2">{result.marks}</td>
                  <td className="border px-4 py-2">{result.gpa}</td>
                </tr>
              ))}
            </tbody>
          </table>
